...
extension ContentView {
    ...
    @MainActor class ViewModel: ObservableObject {
        ...
        func addNewPerson(name: String, picture: UIImage, latitude: Double, longitude: Double) {
            ...
            if let jpegData = picture.jpegData(compressionQuality: 0.8) {
                ...
                persons.append(Person(name: name, picturePath: fileUrl.path, latitude: latitude, longitude: longitude))
